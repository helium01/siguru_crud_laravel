        ...
        <div class="page-wrapper">
            ...
            <div class="white-box col-md-12 col-lg-12 col-sm-12">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Data Kecamatan</h3>
                                <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                                <a class="btn btn-primary" href="/cetakkecamatan">cetak data</a>
            ...
            <form action="/kecamatan/upload" method="post">
            {{csrf_field()}}
                <div class="form-group">
                    <label for="exampleInputEmail1">Nama Kecamatan</label>
                    <input name="nama_kecamatan" type="text"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>

@include('tmp.headercss')
    <title>edit data kecamatan || admin</title>
        ...
        <div class="page-wrapper">
            ...
            @foreach($edit as $e)
            <form action="/kelurahan/edit/{{$e->id_kelurahan}}/post" method="post">
            {{csrf_field()}}
            <div class="form-group">
                    <label for="exampleInputEmail1">Nama Kelurahan</label>
                    <input name="nama_kelurahan" value="{{$e->nama_kelurahan}}" type="text"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">id_kecamatan = {{$e->id_kecamatan}}</label>

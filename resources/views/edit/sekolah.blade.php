@include('tmp.headercss')
    <title>data guru || admin</title>
        ...
        <div class="page-wrapper">
            ...
            @foreach($edit as $e)
            <form action="/sekolah/edit/{{$e->id_sekolah}}/post" method="post">
            {{csrf_field()}}
            <div class="form-group">
                    <label for="exampleInputEmail1">Nama Sekolah</label>
                    <input name="nama_sekolah" value="{{$e->nama_sekolah}}" type="text"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">id_kelurahan = {{$e->id_kelurahan}}</label>

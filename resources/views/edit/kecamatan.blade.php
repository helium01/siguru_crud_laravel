@include('tmp.headercss')
    <title>edit data kecamatan || admin</title>
        ...
        <div class="page-wrapper">
            ...
            @foreach($edit as $e)
            <form action="/kecamatan/edit/{{$e->id_kecamatan}}/post" method="post">
            {{csrf_field()}}
            <div class="form-group">
                    <label for="exampleInputEmail1">Nama Kecamatan</label>
                    <input name="nama_kecamatan" value="{{$e->nama_kecamatan}}" type="text"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
